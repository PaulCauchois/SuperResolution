...
parser.add_argument("--image-path", type=str, default="../../data/downscale/img1.png", help='-')
...
def main():
    ...
    write_image("../../data/output/img1_bicubic_output_from_SRCNN.png", bicubic_image)
    ...
    write_image("../../data/output/img1_output_from_SRCNN.png", sr_image)
